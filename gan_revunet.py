...
class Discriminator(nn.Module):
    ...
    def __init__(self, num_layers=3):
        ...
        self.ch_conv_in = nn.Conv2d(3, 64, 1)
        self.down1 = DownConv(64, 64, num_layers=num_layers) 
        self.down2 = DownConv(64, 64, num_layers=num_layers) 
        self.down3 = DownConv(64, 64, num_layers=num_layers) 
        self.down4 = DownConv(64, 64, num_layers=num_layers) 
        self.down5 = DownConv(64, 64, num_layers=num_layers) 
        self.down6 = DownConv(64, 64, num_layers=num_layers) 
        self.down7 = DownConv(64, 64, num_layers=num_layers) 
        self.down8 = DownConv(64, 64, num_layers=num_layers) 
